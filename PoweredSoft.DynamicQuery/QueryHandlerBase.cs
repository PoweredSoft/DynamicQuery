...
namespace PoweredSoft.DynamicQuery
{
    public abstract class QueryHandlerBase : IInterceptableQueryHandler
    {
        ...
        protected virtual void Reset<TSource>(IQueryable<TSource> queryable, IQueryCriteria criteria, IQueryExecutionOptions options)
        {
            ResetInterceptors(criteria, queryable);
        ...
        public IReadOnlyList<IQueryInterceptor> ResolveInterceptors<TSource>(IQueryCriteria criteria, IQueryable<TSource> queryable)
        {
            var providedInterceptors = queryableInterceptorProviders.SelectMany(t => t.GetInterceptors<TSource>(criteria, queryable)).ToList();
