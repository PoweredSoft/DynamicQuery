...
namespace PoweredSoft.DynamicQuery.Test.Mock
{
    public static class TestSeeders
    {
        public static void SimpleSeedScenario(string testName)
        {
            ...
            {
                ctx.AddRange(new object[]
                {
                    new Customer()
                    {
                        Id = 1, FirstName = "David", LastName = "Lebee", RegisterTime = new DateTime(2018, 10, 3),
                        BirthTime = TimeSpan.Parse("12:22")
                    },
                    new Customer()
                    {
                        Id = 2, FirstName = "John", LastName = "Doe", RegisterTime = new DateTime(2018, 5, 21),
                        BirthTime = TimeSpan.Parse("12:35")
                    },
                    new Customer()
                    {
                        Id = 3, FirstName = "Chuck", LastName = "Norris", RegisterTime = new DateTime(2018, 11, 13),
                        BirthTime = TimeSpan.Parse("12:59")
                    },
                    new Customer()
                    {
                        Id = 4, FirstName = "Nelson", LastName = "Mendela", RegisterTime = new DateTime(2018, 6, 8),
                        BirthTime = TimeSpan.Parse("13:09")
                    },
                    new Customer()
                    {
                        Id = 5, FirstName = "Jimi", LastName = "Hendrix", RegisterTime = new DateTime(2018, 5, 5),
                        BirthTime = TimeSpan.Parse("13:43")
                    },
                    new Customer()
                    {
                        Id = 6, FirstName = "Axel", LastName = "Rose", RegisterTime = new DateTime(2018, 12, 3),
                        BirthTime = TimeSpan.Parse("13:11")
                    },
                    new Customer()
                    {
                        Id = 7, FirstName = "John", LastName = "Frusciante", RegisterTime = new DateTime(2018, 8, 3),
                        BirthTime = TimeSpan.Parse("16:11")
                    },
                    new Customer()
                    {
                        Id = 8, FirstName = "Michael", LastName = "Jackson", RegisterTime = new DateTime(2018, 9, 13),
                        BirthTime = TimeSpan.Parse("20:41")
                    },
                    new Customer()
                    {
                        Id = 9, FirstName = "Anita", LastName = "Franklin", RegisterTime = new DateTime(2018, 10, 2),
                        BirthTime = TimeSpan.Parse("16:41")
                    },
                });
